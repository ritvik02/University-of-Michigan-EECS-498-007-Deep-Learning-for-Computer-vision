...
def three_layer_convnet(x, params):
  ...
  scores = F.linear(scores,fc_w,bias = fc_b)
...
class ThreeLayerConvNet(nn.Module):
  def __init__(self, in_channel, channel_1, channel_2, num_classes):
    ...
    ############################################################################
    # Replace "pass" statement with your code
    self.cn1 = nn.Conv2d(in_channel, channel_1, kernel_size = 5, padding = 2)
    self.cn2 = nn.Conv2d(channel_1, channel_2, kernel_size = 3, padding = 1)
...
def initialize_three_layer_conv_part4():
  ...
  model = nn.Sequential(OrderedDict([
    ('conv 1', nn.Conv2d(C, channel_1,kernel_size = kernel_size_1, padding = pad_size_1)),
    ('relu 1', nn.ReLU()),
    ('conv 2', nn.Conv2d(channel_1, channel_2,kernel_size = kernel_size_2, padding = pad_size_2)),
    ('relu 2', nn.ReLU()),
    ('flatten', Flatten()),
